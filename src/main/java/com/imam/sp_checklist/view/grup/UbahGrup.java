 ...
 * @author Imam-pc
 */
public class UbahGrup extends javax.swing.JDialog {
    ...
    public Grup ubahGrup(Grup param){
        
        grup = param;
        
        txtKodeGrup.setText(param.getId());
        txtNamaGrup.setText(param.getNama());
        lblBuatBy.setText(grup.getBuatBy());
        lblWaktuBuat.setText(String.valueOf(grup.getWaktuDibuat()));
    ...
    private void initComponents() {
        ...
        lblBuatBy.setText("jLabel4");

        lblWaktuBuat.setText("jLabel5");

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);

        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Ubah Grup", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        grup = new Grup();
        grup.setBuatBy(lblBuatBy.getText());
        grup.setWaktuDibuat(Timestamp.valueOf(lblWaktuBuat.getText()));
