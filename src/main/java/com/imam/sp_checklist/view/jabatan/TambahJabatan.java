...
public class TambahJabatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Tambah Jabatan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        JabatanService js = SpringManager.getInstance().getBean(JabatanService.class);
        Jabatan jb = js.find(txtKode.getText());
        
        if(jb != null){
            messageComponent1.showWarning("Kode Jabatan sudah ada");
        }else{
            

            jabatan = new Jabatan();
            jabatan.setBuatBy(pgn.getKaryawan().getNama());
            jabatan.setWaktuDibuat(new java.sql.Timestamp(new java.util.Date().getTime()));
