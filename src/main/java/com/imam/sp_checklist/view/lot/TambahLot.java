 ...
 * @author Imam-pc
 */
public class TambahLot extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Tambah Lot", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        LotService ks = SpringManager.getInstance().getBean(LotService.class);
        Lot kd = ks.find(txtKode.getText());
        
        if(kd != null){
            messageComponent1.showWarning("Kode Lot sudah ada");
        }else if(comboZona.getSelectedItem().equals("Pilih")){
            messageComponent1.showWarning("Zona belum dipilih");
        }else{
            
            lot = new Lot();
            lot.setBuatBy(pgn.getKaryawan().getNama());
            lot.setWaktuDibuat(new java.sql.Timestamp(new java.util.Date().getTime()));
