 ...
 * @author Imam-pc
 */
public class UbahBasement extends javax.swing.JDialog {
    ...
    public Basement ubahBasement(Basement param){
        
        basement = param;
        
        txtKode.setText(basement.getId());
        txtNama.setText(basement.getNama());
        lblBuatBy.setText(basement.getBuatBy());
        lblWaktuBuat.setText(String.valueOf(basement.getWaktuDibuat()));
    ...
    private void initComponents() {
        ...
        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Ubah Basement", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Pengguna pgn = LoginManager.getInstance().getPengguna();
            ...
            basement.setBuatBy(lblBuatBy.getText());
            basement.setWaktuDibuat(Timestamp.valueOf(lblWaktuBuat.getText()));
