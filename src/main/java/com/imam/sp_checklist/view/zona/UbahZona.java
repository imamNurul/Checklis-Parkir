 ...
 * @author Imam-pc
 */
public class UbahZona extends javax.swing.JDialog {
    ...
    public Zona ubahZona(Zona param){
        
        LoadBasementCombo();
        
        zona = param;
        
        txtKode.setText(zona.getId());
        txtNama.setText(zona.getNama());
        lblBuatBy.setText(zona.getBuatBy());
        lblWaktuBuat.setText(String.valueOf(zona.getWaktuDibuat()));
        comboBasement.setSelectedItem(zona.getBasement());
    ...
    private void initComponents() {
        ...
        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Ubah Zona", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(comboBasement.getSelectedItem().equals("Pilih")){
            messageComponent1.showWarning("Basement belum dipilih");
        }else{
            
            zona = new Zona();
            zona.setBuatBy(lblBuatBy.getText());
            zona.setWaktuDibuat(Timestamp.valueOf(lblWaktuBuat.getText()));
